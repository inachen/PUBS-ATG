...
patches = {}
patchname = "patch1"
residue_list = [6,8,42,44,49,68,70,72] #list of integers, assumes chain A
patches[patchname] = residue_list

patchname = "patch2"
residue_list = [6,44,45,46,47,48,49,66,68] #list of integers, assumes chain A
patches[patchname] = residue_list
...
startenergies["patch1"]["UBQ"] = "-128.073"
startenergies["patch1"]["CUE"] = "-192.436"
startenergies["patch1"]["OTU"] = "-419.501"
startenergies["patch1"]["RPN13"] = "-291.273"
startenergies["patch1"]["SH3"] = "-218.005"
startenergies["patch1"]["UQ_CON"] = "-591.388"

startenergies["patch2"] = {}
startenergies["patch2"]["UBQ"] = "-130.039"
startenergies["patch2"]["CUE"] = "-193.363"
startenergies["patch2"]["OTU"] = "-430.637"
startenergies["patch2"]["RPN13"] = "-291.01"
startenergies["patch2"]["SH3"] = "-217.873"
startenergies["patch2"]["UQ_CON"] = "-589.24"
