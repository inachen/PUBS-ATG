...
patches = {}
patchname = "patch1"
residue_list = [8,42,44,49,68,70,74] #list of integers, assumes chain A
patches[patchname] = residue_list

patchname = "patch2"
residue_list = [9,11,35,36,37,40,71,73] #list of integers, assumes chain A
patches[patchname] = residue_list
...
startenergies["patch1"]["UBQ"] = "-128.41"
startenergies["patch1"]["CUE"] = "-192.091"
startenergies["patch1"]["OTU"] = "-417.349"
startenergies["patch1"]["RPN13"] = "-291.799"
startenergies["patch1"]["SH3"] = "-217.417"
startenergies["patch1"]["UQ_CON"] = "-591.961"

startenergies["patch2"] = {}
startenergies["patch2"]["UBQ"] = "-125.74"
startenergies["patch2"]["CUE"] = "-189.572"
startenergies["patch2"]["OTU"] = "-413.052"
startenergies["patch2"]["RPN13"] = "-290.258"
startenergies["patch2"]["SH3"] = "-217.109"
startenergies["patch2"]["UQ_CON"] = "-593.796"
