...
patches = {}
patchname = "patch1"
residue_list = [42,44,49,68,70,72,74] #list of integers, assumes chain A
patches[patchname] = residue_list

patchname = "patch2"
residue_list = [6,8,9,10,68,70,71,73] #list of integers, assumes chain A
patches[patchname] = residue_list
...
startenergies["patch1"]["UBQ"] = "-128.909"
startenergies["patch1"]["CUE"] = "-192.424"
startenergies["patch1"]["OTU"] = "-420.38"
startenergies["patch1"]["RPN13"] = "-291.448"
startenergies["patch1"]["SH3"] = "-199.018"
startenergies["patch1"]["UQ_CON"] = "-592.677"

startenergies["patch2"] = {}
startenergies["patch2"]["UBQ"] = "-126.648"
startenergies["patch2"]["CUE"] = "-189.027"
startenergies["patch2"]["OTU"] = "-412.745"
startenergies["patch2"]["RPN13"] = "-289.713"
startenergies["patch2"]["SH3"] = "-217.492"
startenergies["patch2"]["UQ_CON"] = "-592.446"
