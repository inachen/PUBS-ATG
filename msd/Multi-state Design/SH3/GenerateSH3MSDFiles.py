...
#After ssh'ing into the QB3 cluster, enter the following command '$ssh iqint'
#The password is the same as the one for your normal log in.

radius = 10 # size of repack shell

patches = {}
patchname = "patch1"
residue_list = [6,8,9,10,44,46,68,70] #list of integers, assumes chain A
patches[patchname] = residue_list

patchname = "patch2"
residue_list = [8,42,44,46,47,49,70,72,73] #list of integers, assumes chain A
patches[patchname] = residue_list
...
startenergies["patch1"]["UBQ"] = "-127.735"
startenergies["patch1"]["CUE"] = "-190.126"
startenergies["patch1"]["OTU"] = "-418.927"
startenergies["patch1"]["RPN13"] = "-289.746"
startenergies["patch1"]["SH3"] = "-217.626"
startenergies["patch1"]["UQ_CON"] = "-588.375"

startenergies["patch2"] = {}
startenergies["patch2"]["UBQ"] = "-128.23"
startenergies["patch2"]["CUE"] = "-192.519"
startenergies["patch2"]["OTU"] = "-412.916"
startenergies["patch2"]["RPN13"] = "-290.122"
startenergies["patch2"]["SH3"] = "-216.242"
startenergies["patch2"]["UQ_CON"] = "-588.321"
